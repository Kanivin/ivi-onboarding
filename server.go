...
import (
	...
	"github.com/Kanivin/ivi-onboarding/shared/clients/keyclient"
	"github.com/Kanivin/ivi-onboarding/shared/config"
	"github.com/Kanivin/ivi-onboarding/shared/crypto"
	"github.com/Kanivin/ivi-onboarding/shared/models/registry"
	"github.com/Kanivin/ivi-onboarding/shared/signing-authentication/authentication"
)
...
func main() {
	...
	conf, err := config.Read[config.OnboardingConfig]("config.json")
